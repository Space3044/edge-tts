export const translations = {
    ...
    const STT_ENGINE_TRANSLATIONS = {
      en: { 'stt.subtitle': 'Upload audio and transcribe it with Whisper ASR or ElevenLabs.', 'stt.engine': 'Transcription engine', 'stt.engineWhisper': 'Whisper', 'stt.engineElevenLabs': 'ElevenLabs', 'stt.language': 'Language', 'stt.languageAuto': 'Auto detect', 'stt.tagAudioEvents': 'Keep sound cues', 'stt.tagAudioEventsHint': 'Text may include cues like [laughter] or [applause]. No SRT file is generated.' },
      zh: { 'stt.subtitle': '上传音频，使用 Whisper ASR 或 ElevenLabs 转录。', 'stt.engine': '转录引擎', 'stt.engineWhisper': 'Whisper', 'stt.engineElevenLabs': 'ElevenLabs', 'stt.language': '语言', 'stt.languageAuto': '自动检测', 'stt.tagAudioEvents': '保留音效提示', 'stt.tagAudioEventsHint': '转写文本里可能出现 [笑声]、[掌声] 这类提示；不会生成 SRT 字幕文件。' },
